...
var entity_edit_model  = {
    ...
    menu:null,
    url_index:0,
    url:erp_api_service.VStorageItemGroupByItem,
    top_menu:null,
    checked_record:[],
    innerGrid:[],
    ...
    dispaly_columns:
    	...
    	[
    	 		...
    	 		{ display: '成品数量', name: 'sum_comp_storage', type: 'int',width: 80,
    	 			render:function (rowdata, rowindex, value)
    	 			{
    	 				if(!rowdata.sum_comp_storage)
    	 					return "0";
    	 				return rowdata.sum_comp_storage;
    	 			}
    	 		},
    	 		{ display: '半成品数量', name: 'sum_half_storage', type: 'int',width: 80,
    	 			render:function (rowdata, rowindex, value)
    	 			{
    	 				if(!rowdata.sum_half_storage)
    	 					return "0";
    	 				return rowdata.sum_half_storage;
    	 			}
    	 		},

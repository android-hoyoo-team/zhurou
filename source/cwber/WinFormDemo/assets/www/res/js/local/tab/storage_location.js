var entity_edit_model  = {
    ...
    menu:null,
    url_index:0,
    url:erp_api_service.EntStorage,
    top_menu:null,
    checked_record:[],
    ...
    dispaly_columns:
    	...
    	[
              ...
              {
                  display: '描述', name: 'descr',type: 'text', width: 50,
                  editor: { type: 'text' }
              },
              {
...
function f_initGrid() {
	...
	entity_edit_model.menu = $.ligerMenu({ top: 100, left: 100, width: 120, items:
	  ...
	  $("#storage_location").bind("contextmenu", function (e)
	   {
		  	entity_edit_model .menu.show({ top: e.pageY, left: e.pageX });
		    return false;
		});
    entity_edit_model .manager = $("#storage_location").ligerGrid({

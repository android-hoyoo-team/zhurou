var erp_item_info=Class({
	...
	initialize:function()
	{
		...
		this.name='__erp_item_info'+this.id;
	...
	{
		var _item_info=$("<div id='"+this.name+"_item_info'></div>");
		var target=this;
		$(this.param.div).append(_item_info);
		this.item_info=_item_info.ligerForm({

	...
	$.ajax({
    	...
    	success : function(data) {
    		if (data && data.objects) {
    			...
    			var menus=user_all_info.menus;
    			if(menus)
    				menu_data=changeMenusToTree(menu_obj_list,menus);
    			else
    				menu_data=menu_data;
...
[
    {
        text: '物料管理', isexpand: false, children: [
         // { url: "../tab/item_add.html", text: "部品添加" },
          ...
          { url: "../tab/item_full_info.html", text: "部品查询" },
          { url: "../tab/add_item_drawing.html", text: "图纸管理" },
          { url: "../tab/add_item_technology.html", text: "部品工艺添加" }
        ]
    },
    {
	  ...
	  { 
	   ...
	   { url: "../tab/storage_query_edit.html", text: "库存修改" }, 
   ...
   /*
	 ...
	 */
    {
        text: '投料跟踪', isexpand: false, children: [
          ...
          { url: "../tab/feeding_on_analysis_group_by_c.html", text: "投料(依据分析结果2)"},
          ...
          { url: "../tab/feeding_on_analysis_group_by_c.html", text: "投料单入库" },
          { url: "../tab/admin.html", text: "管理员" }
        ]
    },
];
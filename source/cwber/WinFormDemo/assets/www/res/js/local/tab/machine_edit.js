var entity_edit_model  = {
    ...
    menu:null,
    url_index:0,
    url:erp_api_service.EntMachine,
    top_menu:null,
    checked_record:[],
    ...
    dispaly_columns:  [
                       ...
                       {
                           display: '描述', name: 'descr', width: 150,
                           editor: { type: 'text' }
                       },
                       {
...
function f_initGrid() {
	...
	entity_edit_model.menu = $.ligerMenu({ top: 100, left: 100, width: 120, items:
	  ...
	  $("#matchine").bind("contextmenu", function (e)
	   {
		  	entity_edit_model .menu.show({ top: e.pageY, left: e.pageX });
		    return false;
		});
    entity_edit_model .manager = $("#matchine").ligerGrid({
    	 ...
    	 detail: { height:'auto',onShowDetail: function (row, detailPanel,callback)
    	        {
    	                ...
    	                var ligerGrid= $(grid).css('margin',10).ligerGrid({
    	            		columns: [
    	                              ...
    	                              {
    	                              	display: '编号', name: 'item_number', width: 150,
    	                              	//editor: { type: 'string'},
    	                              ...
    	                              {
    	                                   display: '数量', name: 'count', width: 150,type:'int'
    	                  ...
    	                  detailToEdit: false,
    	                  clickToEdit: false,
    	                  url:erp_api_service.EntRelMachineItem[0],
    	                  method:"get",
    	                  urlFilter:function(){
    	                  ...
    	                  paramFilter:function(){
    	                  	...
    	                  	ps.push({name:"machine_id",value:row.id});
    	                  	return ps;
    	                  },
    	                  onSuccess:function()
    	                  {

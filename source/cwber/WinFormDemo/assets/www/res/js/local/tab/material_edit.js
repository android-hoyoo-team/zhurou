var entity_edit_model  = {
    ...
    menu:null,
    url_index:0,
    url:erp_api_service.EntMaterial,
    top_menu:null,
    checked_record:[],
    ...
    dispaly_columns:
    	...
    	[
              ...
              {
                  display: '类型', name: 'material_type',type: 'text', width: 50,
                  editor: { type: 'text' }
              },
              {
                  display: '长', name: 'length',  align: 'center',type: 'int', width: 50,
                  editor: { type: 'int', height: 60 }
              },
              {
            	  display: '宽', name: 'width',  align: 'center',type: 'int', width: 50,
            	  editor: { type: 'int', height: 60 }
              },
              {
                  display: '高', name: 'height',  align: 'center',type: 'int', width: 50,
                  editor: { type: 'int', height: 60 }
              },
              {
            	  display: '直径', name: 'radius',  align: 'center',type: 'int', width: 50,
            	  editor: { type: 'int', height: 60 }
              },
              {
                  display: '单位', name: 'uint',   align: 'center',type:'int' ,width: 50,
                  editor: { type: 'int', height: 60 }
              },
              {
...
function f_initGrid() {
	...
	entity_edit_model.menu = $.ligerMenu({ top: 100, left: 100, width: 120, items:
	  ...
	  $("#material_edit").bind("contextmenu", function (e)
	   {
		  	entity_edit_model .menu.show({ top: e.pageY, left: e.pageX });
		    return false;
		});
    entity_edit_model .manager = $("#material_edit").ligerGrid({

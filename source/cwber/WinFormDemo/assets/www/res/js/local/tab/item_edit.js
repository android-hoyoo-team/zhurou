	  ...
	  $("#item").bind("contextmenu", function (e)
	   {
        ...
        detail: { height:'auto',onShowDetail: function (row, detailPanel,callback)
        {
        	...
        	var _erp_bom_edit=new erp_bom_edit({div:grid,item_number:row.number});
        } },
        ...
        onBeforeSubmitEdit:function()
        {
            ...
            if (arguments[0].record.__status == "add") {
            	...
            	if(_new.number==null||_new.number==''||_new.number.toString().trim()==''||_new.type==null||_new.type.toString().trim()=='')
            	{
            		tipOnce("提示", "部品信息不完整", 5000);
            		return false;
            	}
            	//var d={};
                param = {

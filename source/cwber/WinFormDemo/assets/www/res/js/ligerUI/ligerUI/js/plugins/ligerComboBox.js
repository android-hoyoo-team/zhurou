...
(function ($)
{
    ...
    $.ligerui.controls.ComboBox.ligerExtend($.ligerui.controls.Input, {
        ...
        setData: function (data)
        {
            ...
            var out = []; 
            if (p.emptyText &&!data.__hasAddEmpty)//!g.emptyRow)
            { 
                g.emptyRow = {};
                g.emptyRow[p.textField] = p.emptyText;
                g.emptyRow[p.valueField] = p.emptyValue!=null?p.emptyValue:null;
                
                data.splice(0, 0, g.emptyRow);
                
                data.__hasAddEmpty=true;
            } 
